...
import { FinanceAnalyticsPanel } from "@/components/admin-finance-panel";
...
export default async function FinancePage() {
  ...
  const [transactions, settlements, allMembers] = await Promise.all([
